...
В форках или новых конфигурациях (я принимаю PR) можете добавлять новые зависимости или менять существующие. Этот пункт отображает лишь тот софт который присущь для desktop конфигурации с моим личным профилем sweetdogs.
