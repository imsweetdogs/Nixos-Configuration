...
- 🔥 Sops-Nix - Для безопасного управления секретами (Обязательно! В будущем).
- 💈 Stylix - Кастомизация темы (в будущем).
- 💭 Nix Topology - Визуализация хостов (в будущем).
- 📁 Качественная структура конфигурации, все конфигурации используют только подготовленные опции.
...
В форках или новых конфигурациях (я принимаю PR) можете добавлять новые зависимости или менять существующие. Этот пункт отображает софт для desktop конфигурации.
